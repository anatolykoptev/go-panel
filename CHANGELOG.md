...
## [1.0.0](https://github.com/anatolykoptev/go-panel/compare/go-panel-v0.19.1...go-panel-v1.0.0) (2026-07-14)
...
* **components:** Grid helper for RenderPage dashboard composition ([d41689e](https://github.com/anatolykoptev/go-panel/commit/d41689e0e6c503dc6493b251efef9c7b8de5a55c))
* **components:** Sparkline ported from oxpulse-admin sparkline.go (no JS, CSP/TSPU-safe; drop local max) ([703c643](https://github.com/anatolykoptev/go-panel/commit/703c643106d3fcebab11bf00a01fc9b85709dc00))
* **components:** StatCard + ported stat-card/delta CSS (reuse oxpulse layout.html:58-86, go-panel --green/--red tokens) ([3203f1c](https://github.com/anatolykoptev/go-panel/commit/3203f1cbab3601d16b6e2999924529e671ac9afd))
...
* **resource,shell:** nav-filter via HasRole + profile block (P3.3 + P7) ([8d13a6c](https://github.com/anatolykoptev/go-panel/commit/8d13a6cfaccb1bd0dfb4a42db719477690f08bab))
...
* **resource:** index route at base path — redirect unauth to login, land auth on first resource (fixes /admin/ 404) ([#10](https://github.com/anatolykoptev/go-panel/issues/10)) ([d5f9b86](https://github.com/anatolykoptev/go-panel/commit/d5f9b8697cd65da2fcc0d1bcbaaec21099d7cca7))
...
* **resource:** RoleAuthenticator capability + fail-closed role validation ([#48](https://github.com/anatolykoptev/go-panel/issues/48)) ([674f6d1](https://github.com/anatolykoptev/go-panel/commit/674f6d16563cb27e066cf09c22ab85da121097b3))
...
* **components:** single-value sparkline visible segment + viewBox (council Med) ([cecf7c6](https://github.com/anatolykoptev/go-panel/commit/cecf7c67efe51c21e3323dce600a93fc7650f05d))
* **components:** WCAG contrast + a11y trend glyph + display-only cards (council High) ([2752782](https://github.com/anatolykoptev/go-panel/commit/2752782ed073b0127013c90247e44b4647630e41))
